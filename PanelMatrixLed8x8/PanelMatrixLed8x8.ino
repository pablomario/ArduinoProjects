...
#define DOT{0, 3, 3, 0, 0}

int dispSpeed = 12;      // Constrols scroll speed (1 minimum, way too fast)
...
const int charNum = 32;        // Number of letters in display string
byte string[charNum][5] = {B,Y,T,E,L,C,H,U,S,DOT,C,O,M,SP};
